...
export const SlideShow = ({ specificApartment }) => {
  const [currentImg, setCurrentImg] = useState(0); //Add a state for the current image index (currentIndex).
  const length = specificApartment.length;
  ...
  if (length === 1) {
    return (
      <SlideShowContainer>
        <SlideShowImg
          src={specificApartment[currentImg]}
